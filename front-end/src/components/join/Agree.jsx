...
const Agree = () => {
  ...
  const handleTermsAgreeChange = (e) => {
    ...
    if (!isChecked) {
      ...
      setAllAgree(privacyAgree && isChecked);
    }
  };
  ...
  const handlePrivacyAgreeChange = (e) => {
    ...
    if (!isChecked) {
      ...
      setAllAgree(termsAgree && isChecked);
    }
  };
    ...
    <div className="agree_wrap">
      ...
      <div className="mustAgree_wrap">
        <div className="mustAgree_content1">
          ...
          <div className="all_agreement">
            <textarea readOnly>
              ...
              준용합니다.」 제2조(정의) ① “몰”이란 LUKS이 재화 또는 용역(이하
              ...
              함은 “몰”에 (삭제) 회원등록을 한 자로서, 계속적으로 “몰”이
        ...
        <div className="mustAgree_content2">
          ...
          <div className="all_agreement">
            <textarea readOnly>
              1. 개인정보 수집목적 및 이용목적 가. 서비스 제공에 관한 계약 이행
              및 서비스 제공에 따른 요금정산 콘텐츠 제공 , 구매 및 요금 결제 ,
              물품배송 또는 청구지 등 발송 , 금융거래 본인 인증 및 금융 서비스
              나. 회원 관리 회원제 서비스 이용에 따른 본인확인 , 개인 식별 ,
              불량회원의 부정 이용 방지와 비인가 사용 방지 , 가입 의사 확인 ,
              연령확인 , 만14세 미만 아동 개인정보 수집 시 법정 대리인 동의여부
              확인, 불만처리 등 민원처리 , 고지사항 전달 2. 수집하는 개인정보
              항목 : 이름 , 생년월일 , 성별 , 로그인ID , 비밀번호 , 자택
